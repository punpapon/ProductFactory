...
<div class="wrapper">
      	...
      	<aside class="main-sidebar">
		     ...
		     <div class="content-wrapper">
		     	...
		     	<div class="panel panel-primary">
					...
					<table id= "table_PrimaryProduct" class="table table-striped table-bordered text-center" style="width:100%">
					  <thead>
					    <tr>
					      <th scope="col">รหัสแบบประกันหลัก</th>
					...
					<div class="text-center" style="padding: 2px 0"></div>
						<div class="modal-footer">
							<button type="button" class="btn btn-primary" data-dismiss="modal" id="bt_CreateProduct">สร้างแบบประกันหลัก</button>
						</div> 
                    </div>
				</div>
			</div>
			<!-- ui-007.1 -->
				<div class="content2" id= "ui-007_1" style="display: none;">
					<div class="panel panel-primary">
						<div  align="center">
							<p class="p-3 mb-2 bg-primary text-white"><B>สร้างแบบประกันหลัก</B></p>
						</div>
						<div class="box-body">		
						<table class="table borderless">
						  ...
						  <tbody>
						    <tr>
						      	<td><input type="radio" id = "rd_CreateProduct" name="Product"><label for="rd_CreateProduct" class="label_input"> สร้างแบบประกันหลักใหม่ (Create New Product)</label>
						     	</td>
						    </tr>
						    <tr>	
						     	<td><input type="radio" id = "rd_CloneProduct" name="Product"><label for="rd_CloneProduct" class="label_input"> สร้างแบบประกันหลักใหม่ จากแบบประกันหลักเดิม (Clone Existing Product)</label>
						     	</td>
						   </tr>
						  </tbody>
						</table>
				...
				<!-- แบบประกัน -->
						<div class="content" id= "ui-007_1_CreateProduct" style="display: none;">
								<div class="panel panel-primary">
									<div  align="center">
										<!-- <hr> -->
											<p class="p-3 mb-2 bg-primary text-white"><B>แบบประกันหลัก</B></p>
										<!-- <hr> -->
									</div>
								<div class="box-body">		
								<table class="table borderless">
								  <thead>
								    <tr>
								     	 <th>กรุณาเลือก ประเภทแบบประกันหลัก</th>
								    </tr>
								  </thead>
								  <tbody >
								    <tr class="col-sm-12">
								    ...
								    <tr>
								    	<td>
								    		 ...
								    		 <input type="checkbox" id="ch_ui007-2" checked="checked"><label for="ch_ui007-2" class="label_input"> การใช้สิทธิ์ตามกรมธรรม์</label><br>
								    		 ...
								    		 <input type="checkbox" id="ch_ui007-7" checked="checked"><label for="ch_ui007-7" class="label_input"> ผลประโยชน์ความคุ้มครอง</label><br>
								    	</td> 
								    </tr>
								  </tbody>
								</table>
						...
						<div class="content" id= "ui-007_1_CloneProduct"  style="display: none;">
							<div class="panel panel-primary">
									<div  align="center">
										<!-- <hr> -->
											<p class="p-3 mb-2 bg-primary text-white"><B>สร้างแบบประกันหลักใหม่จากแบบประกันหลักเดิม Clone Existing Product</B></p>
										<!-- <hr> -->
									</div>
							<!-- <div class="box-header" align="center">
							...
							<div class="box-body">		
							<table class="table table-striped table-bordered text-center" id= "table_PrimaryProduct2" style="width:100%">
							  <thead>
							    <tr>
							      <th scope="col">รหัสแบบประกันหลัก</th>
							      <th scope="col">ชื่อ(ไทย)</th>
								  ...
								  <div class="modal-dialog">
								    ...
								    <div class="panel panel-primary">
								      ...
								      <div class="modal-body" align="center">
								        <p>ต้องการ Clone แบบประกันหลักใช่หรือไม่?</p>
	...
	<script src="js/product_Main_and_OL.js"  charset="utf-8"></script>
	<script src="js/product_CL.js"  charset="utf-8"></script>
	<script src="js/product_OL.js"  charset="utf-8"></script>
	 <script src="js/mainFunctionJS.js"  charset="utf-8"></script>
	 <!-- YRT -->
	 <script src="js/product_YRT.js"  charset="utf-8"></script>
