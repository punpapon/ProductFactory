...
import service.clone.CloneFile;
import service.clone.CloneProductFileUpload;
import service.fnc.ConstantValues;
/**
 * Servlet implementation class RiderCL_CloneData_Servlet
 */
@WebServlet("/RiderCL_CloneData_Servlet")
public class RiderCL_CloneData_Servlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private String userId;
	
	public RiderCL_CloneData_Servlet() {
		super();
	}
