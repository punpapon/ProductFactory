...
import service.center.MainInsureDetailCreateRiderOL;
import service.ctrl.LookupCatValueData;
import service.rider.RiderBenefits;
import service.rider.ctrl.BenefitCat;

public class MainInsureDetailCreateServiceRiderOL {
	MainInsureDetailCreateRiderOL mdc = new MainInsureDetailCreateRiderOL();
