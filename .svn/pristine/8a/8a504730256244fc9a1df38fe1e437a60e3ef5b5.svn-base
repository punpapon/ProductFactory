...
<body>
	<!-- <form class="form-horizontal"> -->
		<div class="row box-body" id="bnfProduct_OL">
			...
			<div style="width:95%; margin:30px auto;"  id="bnf_tab_level1_OL">
					<ul class='nav nav-tabs' id='tabBenefitProduct_OL'>
				...
				<div class="tab-content">
					<div id="menu_ProductBnf1_OL" class="tab-pane fade in active">
					      <jsp:include page="product_menuOL_7_baseplan.jsp" />		  		      
					    </div>
					    
					    <div id="menu_ProductBnf2_OL" class="tab-pane fade">
					      <jsp:include page="product_menuOL_7_rider.jsp" />
					    </div>
