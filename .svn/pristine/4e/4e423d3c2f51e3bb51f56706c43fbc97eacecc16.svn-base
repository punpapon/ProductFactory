...
public class ProductOL_SaveData_Service {
	...
	public String setRateLayout(ArrayList<Rate_layout> lstRateLayout) {
		...
		try {
			...
			ArrayList<Rate_layout> myArray_cat_26 = new ArrayList<>();
			ArrayList<Rate_layout> myArray_cat_27 = new ArrayList<>();
			...
			ArrayList<Rate_layout> myArray_cat_41 = new ArrayList<>();
			ArrayList<Rate_layout> myArray_cat_42 = new ArrayList<>();
			ArrayList<Rate_layout> myArray_cat_39 = new ArrayList<>();
			for(Rate_layout rate_layout : lstRateLayout) {
				...
				}else if(rate_cat_id.equals("26")) {
					myArray_cat_26.add(rate_layout);
				}else if(rate_cat_id.equals("27")) {
					myArray_cat_27.add(rate_layout);
				...
				}else if(rate_cat_id.equals("41")) {
					myArray_cat_41.add(rate_layout);
				}else if(rate_cat_id.equals("42")) {
					myArray_cat_42.add(rate_layout);
				}else if(rate_cat_id.equals("39")) {
					myArray_cat_39.add(rate_layout);
				}
			}
			...
			//if(myArray_cat_1.size() != 0) {
				productBasicinfo = new ProductBasicinfo();
				this.productBasicinfo.doRateLayout("26",myArray_cat_26);
			//}
			
			//if(myArray_cat_2.size() != 0) {
				productBasicinfo = new ProductBasicinfo();
				this.productBasicinfo.doRateLayout("27",myArray_cat_27);
			//}
			...
			//}
				...
				productBasicinfo = new ProductBasicinfo();
				this.productBasicinfo.doRateLayout("41",myArray_cat_41);
				productBasicinfo = new ProductBasicinfo();
				this.productBasicinfo.doRateLayout("42",myArray_cat_42);
				this.productBasicinfo.doRateLayout("39",myArray_cat_39);
