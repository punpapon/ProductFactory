...
<body>
		...
		<div class="panel panel-primary">
			...
			<input type="hidden" name="baseplanCode_CL" id="baseplanCode_CL" value=""/>
				...
				<div class="panel panel-primary">
					<div class="row">
						<div class="col-md-12 panel_head_blue">
							<!-- <div class="input-group" id="norisk_CL">
								<span class="input-group-addon"
									style="background-color: #337AB7;"> <input id="cbBox2_CL"
									onclick="displayPolicyValueCL(2);" type="checkbox">
								</span> <input type="text"
									class="form-control text-center fontColorWhite padding20px"
									style="background-color: #337AB7; border-left: 0;"
									value="ความเสี่ยงต่ำกว่ามาตรฐาน">
							</div> -->
						...
						<div class="col-md-5">
						   ...
						   <input type="hidden" id="select_hidden_value_new2">
							<select class="form-control" id="dbBox2_CL" disabled>
								<option value="NONE">None</option>
								<!-- <option value="CVEM_CL 16 100K_">ต่อทุน 100,000 บาท</option>	 -->											
							</select>
						</div>
					</div>
					<div class="text-center" style="padding: 10px 0"></div>
					<div class="row">
						<div class="col-md-1"></div>
						<div class="col-md-8">							
							<div class="input-group" id="div_file2_CL">								
								<!-- <input type="text" class="form-control" id="input_file_2_CL"
											placeholder="CVEM_CL 14 100K_xxxx.txt" readonly> <label
											class="input-group-btn"> <span disabled id="spanBox2_CL"
											class="btn btn-primary"><font id="validate_input2_CL"
											style="color: red;">*</font>เลือกไฟล์<input
											id="select_file_2_CL" type="file" style="display: none;" disabled>
									</span>
								</label> -->
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12 panel_head_blue">
							<!-- <div class="input-group">
								<span class="input-group-addon"
									style="background-color: #337AB7;"> <input id="cbBox3_CL"
									type="checkbox" onclick="displayPolicyValueCL(3);">
								</span> <input type="text"
									class="form-control text-center fontColorWhite padding20px"
									style="background-color: #337AB7; border-left: 0;"
									value="ตารางมรณะสำหรับคำนวนปิดบัญชี(RPU/ETI)">
							</div> -->
	...
	<div id="cancelBoxCL_menu4" class="modal fade bd-example-modal-sm"
	 ...
	 <!-- modal แจ้งเตือน ความเสี่ยงต่ำกว่ามาตรฐาน-->
	...
	<!-- hidden value -->
	<input type="hidden" id="rateCat_tbRiskStardard" value=""/>
	<input type="hidden" id="rateCat_tbRiskStardard_ageBand" value=""/>
	<input type="hidden" id="rateCat_tbRiskLowStardard" value=""/> 
