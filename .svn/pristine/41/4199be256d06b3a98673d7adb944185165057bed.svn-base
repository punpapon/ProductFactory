	...
	<div class="panel panel-primary">
		...
		<div class="text-center" style="padding: 10px 0"></div>
			<div class="row pd-bt">
				<div class="col-sm-2">
					<label for="lb_contact" class="control-label-left"
						style="margin-top: 8px;"><font id="validate_input1_cl" style="color:red">*</font>รหัสผลิตภัณฑ์</label>
				</div>
				<div class="col-sm-3">
					<input type="text" class="form-control" id="pass_Insurance_product_cl" value="" readonly>
				</div>
				<div class="col-sm-2">
					<input type="text" class="form-control text-right text-capital" id="key_Insurance_product_cl" maxlength="4" onkeyup="keyProduct_cl();">
				</div>
			</div>
			<div class="row pd-bt">
				<div class="col-sm-2">
					<label for="lb_contact" class="control-label-left"
						style="margin-top: 8px;"><font id="validate_input2_cl" style="color:red">*</font>ชื่อ(ไทย)</label>
				</div>
				<div class="col-sm-8">
					<input type="text" id="th_Name_cl" class="form-control" onkeyup="th_Name_cl();"
						value="">
				</div>
			</div>
			<div class="row pd-bt">
				...
				<div class="col-sm-8">
					<input type="text" id="en_Name_cl" class="form-control"
						value="">
				</div>
			</div>
			<div class="row">
				<div class="col-sm-2">
					<label for="lb_contact" class="control-label-left"
						style="margin-top: 8px;"><font id="validate_input3_cl" style="color:red">*</font>ชื่อทางการตลาด (ไทย)</label>
				</div>
				<div class="col-sm-8">
					<input type="text" id="th_marketingName_cl" class="form-control" onkeyup="th_marketingName_cl();"
						value="" >
				</div>
			</div>
			<div class="row pd-bt">
				...
				<div class="col-sm-8">
					<input type="text" id="en_marketingName_cl" class="form-control" value="">
				</div>
			</div>
			<!-- <div id="disabledForm"> -->
			<div class="row" >
				<div class="col-sm-2">
					<label for="lb_contact" class="control-label-left"
						style="margin-top: 8px; color: #330166"><font id="validate_input4_cl" style="color:red">*</font>แบบประกันหลัก</label>
				</div>
				<div class="col-sm-10 style_basic_table2">
					<table class="table borderless">
						<tr>
							<td colspan="10">
								<div id="divtb_PM_Rate">
									<table class="table table-bordered" style="width:1200px;" id="tb_PM_Rate">
										<thead>
											<tr>
												<th width="12%" class="text-center verticalCenter tablecolorhead1 borderBlack">รหัสแบบประกันหลัก</th>
												<th width="25%" class="text-center verticalCenter tablecolorhead1 borderBlack">ชื่อ (ไทย)</th>
												<th width="17%" class="text-center verticalCenter tablecolorhead1 borderBlack" colspan="2">PM_Rate</th>
												...
												<th width="13%" class="text-center verticalCenter tablecolorhead1 borderBlack">ทุน Fix</th>
												<th width="17%" class="text-center verticalCenter tablecolorhead1 borderBlack">NAR</th>	
												<th width="4%" class="text-center verticalCenter tablecolorhead1 borderBlack">ดูค่า</th>
												<th width="4%" class="text-center verticalCenter tablecolorhead1 borderBlack">โหลด</th>											
											</tr>
										</thead>
								...
								<div class="col-sm-7 style_basic_div1">
									<div class="col-md-2" style="padding-right: 0">
										<input class="btn btn-primary width100" type="button"
											...
											data-toggle="modal" href="#modal_Choose_primary_insurance">
									</div>
									<div class="col-md-2" style="padding-right: 0">
										<input class="btn btn-primary width100" type="button"
			...
			<div class="row">
				<div class="col-sm-2">
					<label for="lb_contact" class="control-label-left fontcolortable2"
						style="margin-top: 8px;"><font id="validate_input11_cl" style="color:red; display:none">*</font>สัญญาเพิ่มเติม</label>
				</div>
				<div class="col-sm-10 style_basic_table2">
				<table class="table borderless">
					<tr>
							...
							<table class="table table-bordered " style="width:1200px;"
									...
									<thead>
										<tr>
											...
											<th width="15%" class="text-center verticalCenter tablecolorhead2 borderBlack">รหัสแบบประกันหลัก</th>
											<th width="6%"  class="text-center verticalCenter tablecolorhead2 borderBlack">ประเภทความคุ้มครอง</th>
											...
											<th width="10%" class="text-center verticalCenter tablecolorhead2 borderBlack">ทุน Fix</th>
			...
			<!-- package plan -->
			<div class="displayNone" id="div_plan_YRT">
			<div class="row">
				<div class="col-sm-2">
			...
			<div class="row">
				<div class="col-sm-2"><label class="control-label-left displayNone" style="margin-top: 15px;" id="lb_saPackage">SA Package</label></div>
				<div class="col-sm-10 style_basic_table2">
			...
			<div class="row">
				...
				<div class="col-sm-10 style_basic_div1 margintop_20px margin_bottom_style1 displayNone" id="btn_plan_YRT">
					<div class="col-md-2">
			...
			<div class="row displayNone" id="div_ageRange_CL">
				<div class="col-sm-2">
				...
				<div id="div_tb_ageRange_CL">
							<table class="table table-bordered " style="width:100%" id="tb_ageRange_CL">
									<thead>
										<tr>											
			...
			<div class="row pd-bt">
						...
						<tr>
							<td class="col-sm-8 pd-bt">
								...
								<div class="fontcolortable1 productpadding col-sm-2">
									<input type="checkbox" id="chk_sex_BP1" disabled> <label for="chk_sex_BP1">ชาย</label>
								</div>
								<div class="fontcolortable1 col-sm-3">
									<input type="checkbox" id="chk_sex_BP2" disabled> <label for="chk_sex_BP2">หญิง</label>
								</div>
							</td>
						</tr>
						<tr>
							<td class="col-sm-8 pd-bt">
								<div class="text-right fontcolortable1 col-sm-4">
									<label><font id="validate_input5_cl" style="color:red">*</font>ระยะเวลาชำระเบี้ยประกันภัย</label>
								</div>
						...
						<tr id="tr_coop_commision_CL">
							<td class="productpadding col-sm-7 pd-bt">
								...
								<div class="col-md-2 marginleft_style3">
									<input type="text" class="autoPercent form-control width50px" id="amount_max_commission" onblur="validateMaxCommission(this);" disabled="">
								</div>
					...
					<table>
						...
						<tr>
							<td class="productpadding col-sm-7 pd-bt">
								<div class="text-right col-sm-4"></div>
								<div class="col-sm-1">
									<input type="checkbox" id="chk_finance_PB" checked>									
								</div>
						...
						<tr>
							<td class="productpadding col-sm-7 pd-bt">
								<div class="text-right col-sm-4"></div>
								<div class="col-sm-1">
									<input type="checkbox" id="chk_insurance_contract" checked>									
								</div>
								<div class="productpadding0 col-sm-5">
						...
						<tr>
							<td class="col-sm-7 pd-bt">
								...
								<div class="productpadding col-sm-6">
									<input type="text" id="inputSA_CL" readonly="readonly" class="fontcolortable1 form-control " value="">
		
								</div>
								<div class="col-sm-2">
									<button class="btn btn-primary" id="see_inputSA_CL">ดูค่า</button>
								</div>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="productpadding col-sm-7 pd-bt">
								<div class="text-right col-sm-4"></div>
								<div class="col-sm-1">
									<input type="checkbox" id="chk_sperately_pay" onclick="check_sperately_pay();" disabled>									
								</div>
								<div class="productpadding0 col-sm-5">
										...
										<tbody>
											<!-- <tr>
												<td class="borderBlack">
													<input id="ch_payment_0" class="checkbox_prop" type="checkbox" onclick="ch_payment_fun(0);" value="2" disabled="">
												</td>
												<td class="borderBlack">
													<label for="ch_payment_0">2</label>
												</td>
												<td class="borderBlack">
													<input id="set_Premium_Rate_0" type="text" class="auto text-right form-control checkbox_prop" value="0.00" data-v-min="0.00" data-v-max="999.99" disabled="disabled">
												</td>
											</tr>
											<tr>
												<td class="borderBlack">
													<input id="ch_payment_1" class="checkbox_prop" type="checkbox" onclick="ch_payment_fun(1);" value="3" disabled="">
												</td>
												<td class="borderBlack">
													<label for="ch_payment_1">3</label>
												</td>
												<td class="borderBlack">
													<input id="set_Premium_Rate_1" type="text" class="auto text-right form-control checkbox_prop" value="0.00" data-v-min="0.00" data-v-max="999.99" disabled="disabled">
												</td>
											</tr>
											<tr>
												<td class="borderBlack">
													<input id="ch_payment_2" class="checkbox_prop" type="checkbox" onclick="ch_payment_fun(4);" value="4" disabled="">
												</td>
												<td class="borderBlack">
													<label for="ch_payment_2">4</label>
												</td>
												<td class="borderBlack">
													<input id="set_Premium_Rate_2" type="text" class="auto text-right form-control checkbox_prop" value="0.00" data-v-min="0.00" data-v-max="999.99" disabled="disabled">
												</td>
											</tr> -->
										</tbody>
									</table>
						...
						<tr>
							<td class="productpadding col-sm-7 pd-bt">
								<div class="text-right col-sm-4"></div>
								<div class="col-sm-1">
									<input type="checkbox" id="chk_change_main_person" class="">									
								</div>
								<div class="productpadding0 col-sm-5">
					...
					<div>
						...
						<div class="col-sm-12 style_basic_div1">
							...
							<div class="col-md-2 marginleft_style2">
								<input class="btn btn-primary width80px" type="button" id="delrowCOOP_CL" onclick="delete_rowTbCOOP();" value="ลบ">
							</div>
						</div>	
					</div>
				...
				<div class="paddingleft_style2 col-sm-12 panel panel-default" id="div_COOP_CL_2" style="display: none">
					<div>
						<table class="table table-bordered" id="tb_COOP_CL_2" >
							<thead>
								<tr>
				...
				<!-- ส่วนลด -->
				<div class="paddingleft_style2 col-sm-12 panel panel-default" id="div_COOP_CL_3" style="display: none">
					<div>
						<table class="table table-bordered" id="tb_COOP_CL_3" >
							<thead>
								<tr>
									<th width="50%" class="text-center verticalCenter bg-primary borderBlack" colspan="2">สหกรณ์</th>
									<th width="5%" class="text-center verticalCenter bg-primary borderBlack" rowspan="2"></th>
				...
				<div class="col-md-3 col-md-offset-9 text-right" style="float: right;">
					 <div class="modal-footer" style="border: 0">
						<button class="btn btn-default btn-primary" type="button" id="" onclick="bt_Menu1_Confirm_cl();">บันทึก</button>
						<button class="btn btn-default btn-primary" type="button" id="" data-toggle="modal" data-target="#modal_Cancel">ยกเลิก</button>
					</div>  
			   </div>
			   </div>
				...
				<div class="modal fade" id="modal_select_COOP_CL" role="dialog">
					<div class="modal-dialog modal-lg">
						<div class="panel panel-primary">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="choose_COOP();">ตกลง</button>
								<button type="button" class="btn btn-primary" data-dismiss="modal">ยกเลิก</button>
								...
								<div class="col-sm-5">
									<div id="form_input_file" class="input-group">
										...
										<label class="input-group-btn"> 
											<span id="spanRate1_CL" class="btn btn-primary" >
											<font id="validate_rate1_CL" style="color: red;">*</font><b> เลือกไฟล์ </b>
				...
				<!-- dialog icon see ดูค่า นำเข้า Rate Making - แบบทุน 10k และ 100k เพิ่มเติม -->
				<div class="modal fade" id="modal_input_fileSee_PMRate_inner" role="dialog">
					<div class="modal-dialog">
						<div class="panel panel-primary">
							<div class="panel-heading text-left modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="ex1">
									...
									<table class="table table-striped table-bordered" 
										style="width: 100%" id="tb_input_fileSee_modal_pmRate_inner">
										<thead>
											<tr class="bg-primary">
												<th class="text-center col-md-1" style="border-right-style: none;">Entry age</th>
												<th class="text-center col-md-2" style="border-right-style: none;">Sex</th>
							...
							<div class="row">
								<div class="col-md-4">
									<button type="button" class="btn btn-primary" id="download_tb_input_fileSee_modal_pmRate_inner">ดาวน์โหลด</button></div>
								<div class="col-md-8 text-right">
									<button type="button" class="btn btn-primary" data-dismiss="modal">&nbsp;&nbsp;&nbsp;&nbsp;ปิด&nbsp;&nbsp;&nbsp;&nbsp;</button>
								</div>
								<div class="col-md-2"></div>
				...
				<!-- input file NAR - แบบทุน 10k และ 100k -->
				<div class="modal fade" id="modal_input_file_NAR_ASA" role="dialog">
					<div class="modal-dialog">
						<div class="panel panel-primary">
							<div class="panel-heading text-left">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="ex1">
								...
								<div class="box-body">
									<table class="table table-striped table-bordered" 
										style="width: 100%" id="tb_input_file_modal_NAR_ASA">
											<thead>
											<tr class="borderBlack">
												<th class="text-center bg-primary borderBlack">Plan</th>
												<th class="text-center bg-primary borderBlack">Iloan</th>
												<th class="text-center bg-primary borderBlack">Term</th>
												<th class="text-center bg-primary borderBlack">t</th>
												<th class="text-center bg-primary borderBlack">AmtRe</th>
							...
							<div class="modal-footer">
								<button type="button" id="bt_submit_BaseNAR_ASA" class="btn btn-primary" data-dismiss="modal">บันทึก</button>
								<button type="button" id="bt_cancel_BaseNAR" class="btn btn-primary" data-dismiss="modal">ยกเลิก</button>
							</div>
						</div>
						</div>
				...
				<!-- dialog icon see ดูค่า นำเข้า NAR - แบบทุน 10k และ 100k-->
				<div class="modal fade" id="modal_input_fileSee_NAR_ASA" role="dialog">
					<div class="modal-dialog">
						<div class="panel panel-primary">
							<div class="panel-heading text-left modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
							...
							<div class="ex1">
									...
									<table class="table table-striped table-bordered" 
										style="width: 100%" id="tb_input_fileSee_modal_NAR_ASA">
										<thead>
											<tr class="borderBlack">
												<th class="text-center bg-primary borderBlack">Plan</th>
												<th class="text-center bg-primary borderBlack">Iloan</th>
							...
							<div class="row">
								<div class="col-md-4">
									<button type="button" class="btn btn-primary" id="download_tb_input_fileSee_modal_NAR_ASA">ดาวน์โหลด</button></div>
								<div class="col-md-8 text-right">
									<button type="button" class="btn btn-primary" data-dismiss="modal">&nbsp;&nbsp;&nbsp;&nbsp;ปิด&nbsp;&nbsp;&nbsp;&nbsp;</button>
								</div>
								<div class="col-md-2"></div>
				...
				<!-- เลือกบันทึกสลักหลัง -->
				<div class="modal fade" id="modal_select_endorse" role="dialog">
					<div class="modal-dialog modal-lg">
						...
						<div class="modal-content">
							...
							<div class="modal-body">		
							<input type="hidden" id="hd_endorseID" value="">
							<input type="hidden" id="hd_endorse_code" value="">
							<input type="hidden" id="hd_endorse_parent" value="" >								
							<div class="table_width1">								
								<div class="text-center" style="padding: 10px 0"></div>
								<div class="row">
									<div class="datatbl_endorseAge_CL">
									<table class="table table-bordered" id="tbl_endorseAge_CL">
										<thead>
											<tr class="bg-primary">
										...
										<tbody>
											<!-- <tr id="tr_endorseAge_CL1">
												<td class="text-center"><input type="radio" id="select_endorse_CL1" name="select_endorse_CL" value="ICU"></td>
												<td class="text-center"><label class="lb_underline">ED_EC_ICU_E_0001</label></td>
												<td class="text-left">บันทึกสลักหลังคุ้มครองชดเชยรายวัน กรณี...</td>									
											</tr>
											<tr id="tr_endorseAge_CL2">
												<td class="text-center"><input type="radio" id="select_endorse_CL2" name="select_endorse_CL" value="MAA"></td>
												<td class="text-center"><label class="lb_underline">ED_LC_MAA_E_0001</label></td>
												<td class="text-left">ชื่อไทย_xxxx</td>									
											</tr>	
											<tr id="tr_endorseAge_CL3">
												<td class="text-center"><input type="radio" id="select_endorse_CL3" name="select_endorse_CL" value="MCR"></td>
												<td class="text-center"><label class="lb_underline">ED_EC_MCR_E_0001</label></td>
												<td class="text-left">ชื่อไทย_xxxx</td>									
											</tr>
											<tr id="tr_endorseAge_CL4">
												<td class="text-center"><input type="radio" id="select_endorse_CL4" name="select_endorse_CL" value="RCC"></td>
												<td class="text-center"><label class="lb_underline">ED_EC_RCC_E_0001</label></td>
												<td class="text-left">ชื่อไทย_xxxx</td>									
											</tr>
											<tr id="tr_endorseAge_CL5">
												<td class="text-center"><input type="radio" id="select_endorse_CL5" name="select_endorse_CL" value="OPD"></td>
												<td class="text-center"><label class="lb_underline">ED_EC_OPD_E_0001</label></td>
												<td class="text-left">ชื่อไทย_xxxx</td>									
											</tr> -->					
										</tbody>
									</table>
							...
							<!-- button -->
								<div class="row" align="center">						
										<button type="button" class="btn btn-primary" onclick="addEndorse();">ตกลง</button>						
										<button type="button" class="btn btn-primary" data-dismiss="modal">ยกเลิก</button>												
								</div>
							</div>
						</div>
		...
		<!-- dialog warring drop baseplan -->
				<div class="modal fade" id="modal_dropBasePlan" >
					<div class="modal-dialog">
						<div class="modal-body">
							<div class="box box-danger box-solid  " >
			                  ...
			                  <div class="box-body">
			                    	<label id="txt_dropBasePlan">แน่ใจหรือไม่ว่าจะลบแบบประกันหลัก</label>
			                    	<div class="text-center" style="padding: 10px 0"></div>	
			                    	<div class="row" align="center">						
										<button type="button" class="btn btn-primary" id="bt_approved_dropBasePlanCL">ตกลง</button>						
										<button type="button" class="btn btn-primary" data-dismiss="modal">ยกเลิก</button>												
									</div>
			            	   </div>
			                </div>
...
<!-------------------- hidden value ------------------------->
<input id="type_tb_pmRate" type="hidden">
<input id="base_male" type="hidden" value="N">
<input id="base_female" type="hidden" value="N">
<input id="rider_male" type="hidden" value="N">
<input id="rider_female" type="hidden" value="N">
<input id="sperately_Pay_month_base" type="hidden" >
<input id="sperately_Pay_month_rider" type="hidden" >
<input id="arr_prd_rider_code_delete" type="hidden" >
<input id="sl_unit_age_coordinates" type="hidden"/>
<input id="rate_cat_tbBase" type="hidden"/>
