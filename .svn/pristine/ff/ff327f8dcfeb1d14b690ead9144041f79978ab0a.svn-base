...
<body>
		<div class="panel-body">
			...
			<li  id="menu_OL_2" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_OL_2">การใช้สิทธิ์ตามกรมธรรม์</a></li>			
			...
			<li  id="menu_OL_7" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_OL_7">ผลประโยชน์ความคุ้มครอง</a></li>
			...
			<li  id="menu_CL_2" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_CL_2">การใช้สิทธิ์ตามกรมธรรม์</a></li>			
			<li  id="menu_CL_4" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_CL_4">ผลประโยชน์การขาย</a></li>
			<li  id="menu_CL_5" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_CL_5">ข้อกำหนดการรับประกัน</a></li>
			<li  id="menu_CL_7" style="display: none;" class="disabledAll"><a data-toggle="tab" id="menu_CL_7">ผลประโยชน์ความคุ้มครอง</a></li>
		...
		<div  id= "ol_007_1_1-1" style="display: none;">
			<jsp:include page="product_menuOL_1.jsp" />
		</div>		
		<div  id= "ol_007_1_1-3" style="display: none;">
			<jsp:include page="product_menuOL_3.jsp" />
		</div>	
		<div  id= "ol_007_1_1-2" style="display: none;">
			<jsp:include page="product_menuOL_2.jsp" />
		</div>	
		<div  id= "ol_007_1_1-4" style="display: none;">
			<jsp:include page="product_menuOL_4.jsp" />
		</div>
		<div  id= "ol_007_1_1-5" style="display: none;">
			<jsp:include page="product_menuOL_5.jsp" />
		</div>	
		<div  id= "ol_007_1_1-7" style="display: none;">
			<jsp:include page="product_menuOL_7.jsp" />
		</div>	
		<div  id= "ol_007_1_1-6" style="display: none;">
			<jsp:include page="product_menuOL_6.jsp" />
		</div>
		<!-- --------------- CL ----------------------->
		<div  id= "cl_007_1_1-1" style="display: none;">
			<jsp:include page="product_menuCL_1.jsp" />
		</div>		
		<div  id= "cl_007_1_1-3" style="display: none;">
			<jsp:include page="product_menuCL_3.jsp" />
		</div>	
		<div  id= "cl_007_1_1-2" style="display: none;">
			<jsp:include page="product_menuCL_2.jsp" />
		</div>	
		<div  id= "cl_007_1_1-4" style="display: none;">
			<jsp:include page="product_menuCL_4.jsp" />
		</div>
		<div  id= "cl_007_1_1-5" style="display: none;">
			<jsp:include page="product_menuCL_5.jsp" />
		</div>	
		<div  id= "cl_007_1_1-7" style="display: none;">
			<jsp:include page="product_menuCL_7.jsp" />
		</div>	
		<div  id= "cl_007_1_1-6" style="display: none;">
			<jsp:include page="product_menuCL_6.jsp" />
		</div>		
		<!-- ------------------------------------------->
