...
<body>
			...
			<div class="panel panel-primary">
				...
				<div style="width:95%; margin:30px auto;"  id="warranty_term_tab_level1_CL">
					<ul class="nav nav-tabs">
					    <li class="active"><a data-toggle="tab"  id="tab_menu_term1" href="#menu_term1">ข้อกำหนด</a></li>
					    <li><a data-toggle="tab" id="tab_menu_term2" href="#menu_term2">Policy Wording</a></li>					    
					</ul>
					
					<div class="tab-content">
					    
					    <div id="menu_term1" class="tab-pane fade in active">
					     <%@include file="product_menuCL_5_term.jsp" %>					      		      
					    </div>
					    
					    <div id="menu_term2" class="tab-pane fade">
					      <%@include file="product_menuCL_5_policy.jsp" %>
					    </div>	
	...
	<!-- ดูประวัติ -->
	<div class="modal fade" id="modal_historySale_CL" role="dialog">
	...
	<!-- ปุ่มยกเลิก -->
	<div id="cancelBoxCL_WarrantyTerm" class="modal fade bd-example-modal-sm"
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<button type="button" class="btn btn-primary" onclick="cancelPage('product.jsp?user=<%= request.getParameter("user") %>');">ยืนยัน</button>
							</div>
