 ...
 *
 */
public class RiderCL_SaveData_Service {
	...
	public String setRate_layout(ArrayList<Rate_layout> list) {
		...
		try {
			...
			basicInfo = new RiderBasicInfo();
			this.basicInfo.doRateLayoutTAX(list);
			 datareturn = "Success"; 
	...
	//coverage
		...
		{ 
			...
			try {
				...
				setCoverage(coverage);
				basicInfo = new RiderBasicInfo();
				this.basicInfo.doCoverage(coverage);
				datareturn = "Success";
			} catch (Exception e) {
				datareturn = "Fail";
				e.printStackTrace();
	...
	public String setRate_layout_Standard(ArrayList<Rate_layout> list) {
		...
		try {
			...
			this.premiumCal.doPMStandard(list);
			 datareturn = "Success"; 
		} catch (Exception e) {
			e.printStackTrace();
			datareturn = "Fail";
	...
	public String setRate_layout_Special(ArrayList<Rate_layout> list) {
		...
		try {
			setLstRate_layout(list);
			premiumCal = new BasePlanPremiumCal();
			this.premiumCal.doPMSpecial(list);
			 datareturn = "Success"; 
		} catch (Exception e) {
			e.printStackTrace();
			datareturn = "Fail";
	...
	public String setRate_layout_BetweenAge(ArrayList<Rate_layout> list) {
		...
		try {
			setLstRate_layout(list);
			premiumCal = new BasePlanPremiumCal();
			this.premiumCal.doPMBetweenAge(list);
			 datareturn = "Success"; 
		} catch (Exception e) {
			e.printStackTrace();
			datareturn = "Fail";
	...
	//table_policy_value
		public String setRate_layout_standard_risk(ArrayList<Rate_layout> list) {
			...
			try {
				...
				this.valueInsue.doRiskStandard(list);
				datareturn = "Success"; 
			} catch (Exception e) {
				e.printStackTrace();
				datareturn = "Fail";
		...
		public String setRate_layout_standard_risk_row(ArrayList<Rate_layout> list) {
			...
			try {
				setLstRate_layout(list);
				valueInsue = new BasePlanValueInsue();
				this.valueInsue.doRiskLowStandard(list);
				datareturn = "Success"; 
			} catch (Exception e) {
				e.printStackTrace();
				datareturn = "Fail";
