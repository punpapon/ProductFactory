		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<input type="text" id="code_Coverage_CL" class="form-control" disabled>
					</div>
				</div>
				<div class="row">
					<div class="col-md-1"></div>
					...
					<div class="col-md-3">
						<input type="text" id="approve_nameTH_CL" class="form-control" value=""
							disabled>
					</div>
				...
				<div class="row" id="div_policyStatus_CL">
					...
					<div class="col-md-2">
						<input type="text" id="status_policy" class="form-control" style="color: green;" value="อนุมัติแล้ว" disabled>
					</div>
				</div>
