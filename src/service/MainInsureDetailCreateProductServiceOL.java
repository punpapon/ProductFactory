...
import service.center.MainInsureDetailCreateProductOL;

public class MainInsureDetailCreateProductServiceOL {
	MainInsureDetailCreateProductOL mdc = new MainInsureDetailCreateProductOL();
