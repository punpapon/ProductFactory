...
public class TxnAppendixProductControlData {

	private RteResult rteResult;
	private final String RTE_PATH = RtePath.RTE.getValue();
	
	public ArrayList<Txn_underwrite> searchAppenDixProduct(String prd_code) throws Exception
	{
	...
	public void insertTxn_approve(ArrayList<Txn_appendix_product> listAppenDixProduct) throws Exception 
	{
		boolean status = true;
		try {
			Object [] param = new Object [] {"INSERT",listAppenDixProduct}; 
			this.rteResult = new RteResult(RTE_PATH+".unw."+"RteUWTxnAppendixProductIU", param);
			rteResult.saveData();
		} catch (Exception e) {
			status = false;
			throw e;
