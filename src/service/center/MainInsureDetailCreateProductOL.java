...
public class MainInsureDetailCreateProductOL {
	...
	private void setBasicInfo() throws Exception 
	{
		...
		setPM_Rate(ConstantRateCatIDValues.getPmstdRateCat());
	...
	{
		setListSaleChannelAccessData(new SalesChannelData().searchInsuranceType());
	}
