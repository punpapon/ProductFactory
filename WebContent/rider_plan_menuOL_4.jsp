...
<body>
	<div id="mainPolicy_OL" class="row box-body">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<input type="hidden" name="baseplanCode_OL" id="riderCode_OL" value=""/>
				...
				<div class="panel panel-primary">				
					...
					<div class="row">
						...
						<div class="col-sm-10"><label>นำเข้า CV </label>&nbsp;&nbsp;<span class="errorFont" id="CVFile_validate_OL">(กรุณานำเข้าไฟล์อย่างน้อย 1 ไฟล์)</span></div>
