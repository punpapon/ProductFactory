...
<body>
	<form class="form-horizontal">
		<div class="row box-body" id="div_main_menuOL_8">
			<div class="panel panel-primary">
				...
				<div class="form-group">
					...
					<div class="col-sm-10" id="div_person_OL">
						<table class="table table-striped table-bordered" id="tb_personProtected_OL">
							<thead>
								<tr>
						...
						<div class="col-md-7">
							<div class="col-md-6">
								<button type="button" class="btn btn-primary width80px"
									id="bt_ui005_2_Confirm_ol" onclick="bt_person_Confirm_OL();">บันทึก</button>
							</div>
							<div class="col-md-3">
								<button type="button" class="btn btn-primary width80px"
									data-dismiss="modal" data-toggle="modal"
									data-target="#cancelBoxOL_Person">ยกเลิก</button>
							</div>
						</div>
					</div>
				</div>
	...
	<!-- ปุ่มยกเลิก -->
	<div id="cancelBoxOL_Person" class="modal fade bd-example-modal-sm"
