	...
	<div class="row box-body" id="div_main_menuBasic_Info">
		<div class="panel panel-primary">
				...
				<div class="col-sm-12">
					<div class="col-sm-3">
						<label for="lb_contact" class="control-label-left"
							style="margin-top: 8px;">รหัสความคุ้มครองแบบประกัน</label>
					</div>
					<div class="col-xs-3">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-2 style_col_width14">
						<label for="thai_Name_cl" class="control-label-left"
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="col-sm-2 style_col_width14">
						<label for="eng_Name_cl" class="control-label-left"
							style="margin-top: 8px;"><!-- <font id="validate_input3_cl"
							style="color: red;">*</font> --> ชื่อ(อังกฤษ)
						</label>
					</div>
					<div class="col-xs-10 style_col_width82">
						<input type="text" class="form-control" id="eng_Name_cl"></div>
				</div>
			</div>		
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<!-- <div class="col-xs-4 style_col_width29">
						<input type="text" class="form-control" id="appStart_date_cl"
							onblur="checkappStart_CL ();" onclick="appStart_date();" placeholder="dd/mm/yyyy"
							onkeyup=""
							maxlength="10">
					</div>
					<div class="col-sm-1 style_col_width3 marginleft_style6">
					...
					<div class="col-xs-4 style_col_width29">
						<input type="text" class="form-control" id="appTo_date_cl"
							onblur="checkappTo_CL ();" onclick="appTo_date();" placeholder="dd/mm/yyyy"
							onkeyup=""
							maxlength="10">
					</div> -->
				...
				<div class="col-sm-6">
					...
					<div class="col-xs-3">
						<input type="text" class="auto form-control text-center" id="age_Start_cl"
							onblur="checkdata();" onkeypress='validate(event)' data-v-min="0" data-v-max="99" maxlength="2">
					</div>
					<div class="col-sm-1">
						<label for="lb_contact" class="control-label-left"
							style="margin-top: 8px;"> <!-- <font id="validate_input7_cl"
							style="color: red;">*</font> -->ถึง
						</label>
					</div>
					<div class="col-xs-3">
						<input type="text" class="auto form-control text-center" id="age_To_cl"
							onblur="checkdata();" onkeypress='validate(event)' data-v-min="0" data-v-max="99" maxlength="2" maxlength="2">
					</div>
					<div class="col-sm-1">
						<label for="lb_contact" class="control-label-left"
				...
				<div class="col-sm-6">
					...
					<div class="col-xs-3">
						<input type="text" class="auto form-control text-center"
							id="maximum_Protection_To_cl" onkeypress='validate(event)' onkeyup='max_coverage_cl();'
							maxlength="2" data-v-min="0" data-v-max="99" onblur="checkMaxProtectionAge_CL();">
					</div>
					<div class="col-sm-1">
			...
			<div class="row">
				<div class="col-sm-1"></div>
				<div class="col-sm-3">
					<table class="table panel panel-primary table borderless" align="right" id="tbl_BI_Mode_CL">
						<thead>
							<tr class="bg-primary">
					...
					<table class="table panel panel-primary table borderless" align="right" id="tbl_BI_FilingCN_CL">
							<thead>
							<tr class="bg-primary">
					...
					<!-- <table class="table panel panel-primary table borderless" align="right" id="tbl_BI_SaleCN_CL">
						  <thead>
							<tr class="bg-primary">
								<th scope="col" colspan="2">
				...
				<div class="col-sm-7 panel panel-primary border-custom">
					<table class="table borderless">
						<tr>
							<td>
							<label class="col-sm-1"><font id="validate_input11_cl" style="color: red;">*</font>เพศ</label> 
								<label class="col-sm-1" for="ch_male_cl">ชาย</label>
								<div class="col-sm-1">
									<div class="input-group">
										<input type="checkbox" id="ch_male_cl" name="ch_gender_cl[]" value="MALE">
									</div>
								</div> 
								<label class="col-sm-1" for="ch_female_cl">หญิง</label>
								<div class="col-sm-1">
									<div class="input-group">
						...
						<tr>
							<td>
								<div class="col-sm-7">
									<table class="table panel panel-primary table borderless" align="right" id="tbl_BI_AgeCal_CL">
											<thead>
											<tr class="bg-primary">
												<th scope="col" colspan="2">
						...
						<tr>
							<td><label class="col-sm-5"> <!-- <font
									id="validate_input12_cl" style="color: red;">*</font> -->เบี้ยประกัน
							</label>
								<div class="col-sm-7">
									<div class="input-group col-sm-7">
										<select class="form-control " id="sl_insurance_premium_cl">	
						...
						<tr>
							<td><label class="col-sm-5"> <!-- <font
									id="validate_input13_cl" style="color: red;">*</font> -->ประเภทความคุ้มครอง
							</label>
								<div class="col-sm-7">
									<div class="input-group col-sm-7">
										<select class="form-control" id="sl_coverage_type_cl">
											<option value="NONE">None</option>																				
										</select>
									</div>
								</div></td>
						...
						<tr>
							<td><label class="col-sm-5"> <!-- <font
									id="validate_input14_cl" style="color: red;">*</font> -->ประเภทสัญญา
							</label>
								<div class="col-sm-7">
									<div class="input-group col-sm-7">
										<select class="form-control" id="sl_contract_type_cl">
											<option value="NONE">None</option>								
										</select>
									</div>
								</div></td>
						...
						<tr>
							<td>
								<div class="text-center" style="padding: 10px 0"></div>
								<div class="col-sm-6">
									<label><font id="validate_input15_cl"
						...
						<tr>
							<td>
								<div class="col-sm-1">
									<div class="input-group">
										<input type="radio" id="rd_anniversary_cl"
											name="rd_Term_of_insurance_cl" value="TO_AGE">
									</div>
								</div>
								<div>
								...
								<div class="col-sm-2">
									<div class="input-group">
										<input type="text" class="auto form-control"
											id="text_anniversary_cl" onkeyup="text_anniversary_cl();"
											onblur="checkMax_text_anniversary_cl();" disabled="disabled"
											onkeypress="validate(event)" data-v-min="0" data-v-max="99" maxlength="2">
									</div>
								</div>
								<div class="col-sm-2">
									<select class="form-control width82px list_unit1" id="dmy_1_cl" onchange="text_anniversary_cl();"
										disabled="disabled">
										<!-- <option value="NONE">None</option> -->
									</select>
								</div>
						...
						<tr>
							<td>
								<div class="col-sm-1">
									<div class="input-group">
										<input type="radio" id="rd_Time_length_cl"
											name="rd_Term_of_insurance_cl" value="TO_YEAR">
									</div>
								</div>
								<div>
							...
							<div class="col-sm-1"></div>
								<div class="col-sm-10">
									<table class="table table-striped table-bordered text-center"
										width="100%" id="tb_BasicInformation1">
										<thead>
											<tr>
						...
						<tr>
							<td>
								<div class="col-sm-12">
									<label><br> <font id="validate_input16_cl"
						...
						<tr>
							<td>
								<div class="col-sm-1">
									<div class="input-group">
										<input type="radio" id="rd_insurance_premium_cl"
											name="rd_Time_insurance_premium_cl" value="TO_AGE">
									</div>
								</div>
								<div>
								...
								<div class="col-sm-2">
									<select class="form-control width82px list_unit1" id="dmy_3_cl" onchange="text_insurance_premium_cl();"
										disabled="disabled">
										<option value="NONE">None</option>
									</select>
								</div>
						...
						<tr>
							<td>
								<div class="col-sm-1">
									<div class="input-group">
										<input type="radio" id="rd_Time_insurance_premium_cl"
											name="rd_Time_insurance_premium_cl" value="TO_YEAR">
									</div>
								</div>
								<div>
								...
								<div class="col-sm-2">
									<select class="form-control width82px list_unit1" id="dmy_4_cl" onchange="text_Time_insurance_premium_cl();"
										disabled="disabled">
										<option value="NONE">None</option>		
									</select>
								</div>
										...
										<thead>
											<tr>
												...
												<th width="15%" class="text-center bg-primary borderBlack"
													style="vertical-align: middle;" colspan="3">ตารางมรณะ<br>ที่ใช้ในการคำนวณอัตราเบี้ย</th>
											</tr>
											<tr>
										...
										<thead>
											<tr>
												<th width="10%" class="text-center bg-primary borderBlack"
													style="vertical-align: middle;"  rowspan="2">เลือก</th>
												<th width="15%" class="text-center bg-primary borderBlack"
													style="vertical-align: middle;" colspan="3">ตารางทุพพลภาพ<br>ที่ใช้ในการคำนวณอัตราเบี้ย</th>
											</tr>
											<tr>
												<th class="text-center bg-primary borderBlack" width="10%">
													เพศ
								...
								<div class="col-sm-3">
									<div class="input-group">
										<input type="text" class="auto text-right form-control"
											id="text_Calculate_premiums_1cl" value=""
						...
						<tr>
							<td><label class="col-sm-7"> <!-- <font
									id="validate_input17_2cl" style="color: red;">*</font> -->อัตราดอกเบี้ยที่ใช้ในการคำนวณทุน
							</label>
								<div class="col-sm-1"></div>
								<div class="col-sm-3">
									<div class="input-group">
										<input type="text" class="auto text-right form-control"
											id="text_Calculate_premiums_2cl" value=""
											data-v-min="0.00" data-v-max="999.99">
									</div>
								</div> <label class="col-sm-1">%</label></td>
						</tr>
						<tr>
							<td>
								...
								<!-- <div class="text-right col-sm-7">
									<div class="col-md-4"></div>
									<div class="col-md-4" style="padding-right: 0">
										<button class="btn btn-primary width100" id="btn_add_rowTaxBasic_CL"
						...
						<tr>
							<td><label class="col-sm-2">หมายเหตุ</label>
								<div class="col-sm-9">
									<div class="input-group">
										<textarea class="height100px" id="Basic_remark" cols="50"></textarea>
									</div>
								</div></td>
						</tr>
						<tr>
