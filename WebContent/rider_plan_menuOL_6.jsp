	...
	<div class="row box-body" id="approve_OL">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="row" id="div_policyStatus_OL">
					<div class="col-md-1"></div>
					<div class="col-md-2">
						<label>Policy Wording Status</label>
					</div>
					<div class="col-md-2">
						<input type="text" id="status_policy_OL" class="form-control" style="color: green;" value="อนุมัติแล้ว" disabled>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<textarea class="form-control resizeNone" rows="6" id="comment_OL" style="color: red;" disabled></textarea>
					</div>
				</div>
				<div class="row">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary" onclick="bt_approved_OL('request');"
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary" 
											data-dismiss="modal" onclick="bt_approved_OL('approved');">ยืนยัน</button>
									</div>
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal">ยกเลิก</button>
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="bt_approved_OL('not_approved');">ยืนยัน</button>
									</div>
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal">ยกเลิก</button>
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="bt_approved_OL('request_update');">ยืนยัน</button>
									</div>
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal">ยกเลิก</button>
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary" 
											data-dismiss="modal" onclick="bt_approved_OL('approved_update');">ยืนยัน</button>
									</div>
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal">ยกเลิก</button>
						...
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal" onclick="bt_approved_OL('not_approved_update');">ยืนยัน</button>
									</div>
									<div class="col-md-6">
										<button type="button" class="btn btn-primary"
											data-dismiss="modal">ยกเลิก</button>
